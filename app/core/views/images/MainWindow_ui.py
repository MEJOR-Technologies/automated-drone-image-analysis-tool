...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionImageAnalysisGuide = QAction(MainWindow)
        self.actionImageAnalysisGuide.setObjectName(u"actionImageAnalysisGuide")
        self.actionImageAnalysisGuide.setFont(font)
...
"The wizard will close this window and open with all settings pre-populated.", None))
