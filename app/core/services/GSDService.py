...
class GSDService:
    ...
    Provides methods for computing GSD at specific pixels, average GSD,
    and ground distances accounting for camera tilt and altitude.

    Attributes:
        pel_size: Pixel size in meters.
        focal_length: Focal length in meters.
        image: Image size as (width, height) in pixels.
        altitude: Altitude in meters.
        title_angle: Tilt angle in degrees (0 is nadir).
        principalPoint: Principal point in pixels as (x, y).
    """

    def __init__(self, focal_length, image_size, altitude, tilt_angle, sensor, principalPoint=None):
        """Initialize the GSDService with camera and flight parameters.

        Args:
            focal_length: Focal length of the camera in millimeters.
            image_size: Size of the image in pixels as (width, height).
            altitude: Altitude of the drone in meters.
            tilt_angle: Tilt angle of the camera in degrees (0 is nadir).
            sensor: Sensor size in millimeters as (width_mm, height_mm).
            principalPoint: Principal point in millimeters as (x_mm, y_mm).
    ...
    def compute_average_gsd_between_points(self, row1, col1, row2, col2):
        """Compute the average GSD between two image points.
        ...
        Args:
            row1: Row coordinate of first point.
            col1: Column coordinate of first point.
            row2: Row coordinate of second point.
            col2: Column coordinate of second point.

        Returns:
            Average GSD between the two points in centimeters.
        """
    ...
    def compute_ground_distance(self, row1, col1, row2, col2):
        """Compute the ground distance between two image points accounting for variable GSD.
        ...
        Args:
            row1: Row coordinate of first point (typically image center).
            col1: Column coordinate of first point (typically image center).
            row2: Row coordinate of second point (e.g., AOI center).
