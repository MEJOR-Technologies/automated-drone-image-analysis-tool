...
################################################################################
## Form generated from reading UI file 'MRMapWizard.ui'
##
...
class Ui_MRMapWizard(object):
    def setupUi(self, MRMapWizard):
        if not MRMapWizard.objectName():
            MRMapWizard.setObjectName(u"MRMapWizard")
        self.verticalLayout_root = QVBoxLayout(MRMapWizard)
        self.verticalLayout_root.setObjectName(u"verticalLayout_root")
        self.verticalLayout_root.setContentsMargins(0, 5, 0, 0)
        self.widgetComplex = QWidget(MRMapWizard)
        ...
        self.widgetAggressiveness = QWidget(MRMapWizard)
        ...
        self.retranslateUi(MRMapWizard)

        QMetaObject.connectSlotsByName(MRMapWizard)
    # setupUi

    def retranslateUi(self, MRMapWizard):
        self.labelComplexScenes.setText(QCoreApplication.translate("MRMapWizard", u"Do your images contain complex scenes with buildings, vehicles, or mixed manmade ground cover?", None))
        self.radioComplexNo.setText(QCoreApplication.translate("MRMapWizard", u"No", None))
        self.radioComplexYes.setText(QCoreApplication.translate("MRMapWizard", u"Yes", None))
        self.labelAggressiveness.setText(QCoreApplication.translate("MRMapWizard", u"How aggressively should ADIAT be searching for anomalies?", None))
        self.labelNote.setText(QCoreApplication.translate("MRMapWizard", u"Note: A higher setting will find more potential anomalies but may also increase false positives.", None))
        pass
    # retranslateUi
